...
public class DamageInfo
{
    ...
    public float effectValue;       // 효과 강도
    public float dotDamageAmount;   // 도트 데미지 양 (불, 독 등)
    ...
    public DamageInfo(float amount, EffectType type, GameObject source = null)
    {
        ...
        this.effectValue = 0.3f;    // 기본 값 (상황에 따라 다름)
        this.dotDamageAmount = 1f;  // 기본 도트 데미지 양
        this.tickInterval = 0.3f;   // 기본 도트 데미지 틱 간격
    }
}
